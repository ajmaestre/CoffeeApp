...
@Component({
  selector: 'app-links-cdp',
  templateUrl: './links-cdp.component.html',
  styleUrls: ['./links-cdp.component.css']
})
export class LinksCdpComponent implements OnInit {
  ...
  isRoute(route: string){
    ...
    const regexp_data_two = /recopilation/;
    const regexp_data_three = /description/;
    const regexp_data_four = /exploration/;
    const regexp_data_five = /verification/;
